...
namespace MongoDB.Web.Providers
{
    public class MongoDBRoleProvider : RoleProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            var mongoDatabase = MongoDatabase.Create(ConfigurationManager.ConnectionStrings[config["connectionStringName"] ?? "MongoConnection"].ConnectionString ?? "mongodb://localhost");
